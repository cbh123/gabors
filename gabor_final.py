...
def create_gabor(rot,RF_siz,Div,plot):
    ...
    alt_fb = np.zeros((39,39,1,34),dtype=np.float32)
    ...
    for k in range(0,numFilterSizes):
        for r in range(0,numSimpleFilters):
            ...
            img_center = ceil(20.0) ## New center for padding with zeros
...
## Save Dictionary ----------------------
np.save('/Users/charlieholtz/Desktop/hermann/Gabor Filters/gabor_dictionary.npy', gabor_dictionary)
